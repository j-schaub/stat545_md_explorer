...
typeof(my_commute) #double, basically 'real numbers'
typeof(preamble) #character, basically 'letters'
...
commute <- c(my_commute,45,60,35,20,40) #concept of magic numbers, only having 
#to change it once at beginning instead of looking for every incidence of '20'
